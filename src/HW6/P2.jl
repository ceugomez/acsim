function CalculateControlGainsSimpleSLC_Nondim_Ttwistor(aircraft_parameters, trim_definition, trim_variables)
    ...
    wn_height = (1/10)*wn_pitch; #%%%<---------- STUDENT SELECT
    zeta_height = 5; #%%%<---------- STUDENT SELECT
    ...
    zeta_airspeed = 0.5; #%%%<---------- STUDENT SELECT
